#!/usr/bin/python
#****                                                                                         
# *** Based on Motion Detection code from here ****  
...
class MotionDetectorInstantaneous():
    ...
    def __init__(self,threshold=20, doRecord=True, showWindows=True):
        ...
        self.MotionCollection = mongoLABhelper.startMotionDatabaseURI("MotionCollection", "uri")
        self.AlertCollection = mongoLABhelper.startAlertDatabaseURI("AlertCollection", "uri")
