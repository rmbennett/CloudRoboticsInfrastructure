#!/usr/bin/python
#****                                                                                         
# *** Based on Motion Detection from here ****  
...
class MotionDetectorInstantaneous():
    ...
    def __init__(self,threshold=20, doRecord=True, showWindows=True):
        ...
        self.collection = mongoLABhelper.startMotionDatabaseURI("MotionCollection", "mongodb://<username>:<password>@ds047948.mongolab.com:47948/cloudrobotics")
